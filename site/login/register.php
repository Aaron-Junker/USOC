<?php
  ...
  if($register){
    $sql = 'INSERT INTO User (Username, Mail, Password, Type) VALUES ('."'".$_POST["U"]."'".','."'".$_POST["M"]."'".','."'".password_hash($_POST["P"],PASSWORD_DEFAULT,["salt"=>"\@]FBGsU,P?eFbHb)!'uaIt95JYhlH%TrRf+rZt|/~0T){%DjBasjhklozu"])."'".',0);';
